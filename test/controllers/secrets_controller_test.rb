...
class SecretsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create secret" do
    assert_difference('Secret.count') do
      post secrets_url, params: { secret: { message: @secret.message, password: @secret.password, url: @secret.url } }
    end
  ...
  test "should update secret" do
    patch secret_url(@secret), params: { secret: { message: @secret.message, password: @secret.password, url: @secret.url } }
